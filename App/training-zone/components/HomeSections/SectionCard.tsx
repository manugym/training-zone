  ...
  return (
    <ThemedView style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={styles.offerContainer}>
        <Text style={[styles.offerTitle, { color: theme.text }]}>¿Qué servicios ofrecemos?</Text>
        <Text style={[styles.offerDescription, { color: theme.text }]}>
        ...
        <View style={styles.cardsGrid}>
          <HomeCard
            icon={<MaterialCommunityIcons name="karate" size={48} color={theme.primary} />}
          ...
          />
          <HomeCard
            icon={<FontAwesome6 name="users" size={48} color={theme.primary} />}
          ...
          />
          <HomeCard
            icon={<Ionicons name="phone-portrait-outline" size={48} color={theme.primary} />}
